...
@author: david
"""
'''traget label和user的选择至关重要，该数据库中许多label在user中基本没有
        相应的可用数据，所以选择不慎就会报错（如出现precision分母为0）或者
        得出非常奇怪的acc和precision！！
        
        另外本程序中label的范围划定也很关键，'''
...
uuid = 'F:/audio_database_ucsd/ExtraSensory.per_uuid_features_labels/0A986513-7828-4D53-AA1F-E02D6DF9561B';
